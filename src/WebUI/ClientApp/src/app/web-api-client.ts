...
export interface IFileClient {
    uploadFile(command: UploadFileCommand): Observable<Result>;
}
...
export class FileClient implements IFileClient {
    ...
    protected processUploadFile(response: HttpResponseBase): Observable<Result> {
...
export class UploadFileCommand implements IUploadFileCommand {
    file1?: UploadedFile | undefined;
    file2?: UploadedFile | undefined;
    byColumn?: number;
    ...
    init(_data?: any) {
        if (_data) {
            this.file1 = _data["file1"] ? UploadedFile.fromJS(_data["file1"]) : <any>undefined;
            this.file2 = _data["file2"] ? UploadedFile.fromJS(_data["file2"]) : <any>undefined;
            this.byColumn = _data["byColumn"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["file1"] = this.file1 ? this.file1.toJSON() : <any>undefined;
        data["file2"] = this.file2 ? this.file2.toJSON() : <any>undefined;
        data["byColumn"] = this.byColumn;
        return data; 
    }
}
